...
> [!WARNING]
> Якщо у вас виникли труднощі з цією бібліотекою, будь ласка, [**створіть Issue**](https://github.com/denis-akazuki/samp-mobile-cef/issues/new). Я не допомогаю ніде, крім офіційного репозиторію на GitHub.

> [!NOTE]
> Для цієї бібліотеки існує Telegram чат, де ви зможете отримати допомогу та знайти однодумців з теми мобільного SA:MP - [приєднуйтесь до нас](https://t.me/samp_mobile_cef).
